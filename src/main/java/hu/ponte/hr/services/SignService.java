...
public class SignService {
    ...
    public String sign(String originalName, String uploadsDir) throws TechnicalException {
        try {
            ...
            throw new TechnicalException("Something went wrong during signing picture!");
        }
    }
}
